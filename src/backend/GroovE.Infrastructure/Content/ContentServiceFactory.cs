...
internal static class ContentServiceFactory
{
    public static IContentService Create(IServiceProvider provider)
    {
        ...
        return config.ContentService switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(config.ContentService), config.ContentService, "Unknown content service type")
        };
    }
}
